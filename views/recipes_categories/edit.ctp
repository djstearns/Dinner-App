...
<?php echo $this->Form->create('RecipesCategory');?>
	<fieldset>
 		<legend><?php __('Edit Recipes Category'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('RecipesCategory.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('RecipesCategory.id'))); ?></li>
